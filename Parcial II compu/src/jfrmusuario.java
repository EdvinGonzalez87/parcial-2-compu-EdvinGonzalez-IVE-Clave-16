...
public class jfrmusuario extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String ususrioCorrecto="Edvin";
        String ClaveCorrecta="1987";
        
        String usuario= JOptionPane.showInputDialog("Ingrese el usuario: ");
        String clave= JOptionPane.showInputDialog("Ingrese el usuario: ");
        
        if (usuario.equals(ususrioCorrecto)&& clave.equals(ClaveCorrecta)){
            JOptionPane.showMessageDialog(null,"Bienvenido" +usuario);
        } else{
            JOptionPane.showMessageDialog(null,"la contraseña o el ususario son incorrectos");
            System.exit(0);
        }
